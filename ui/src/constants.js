...
export const campagnesDisplayModeOptions = [
  {
    label: CAMPAGNES_DISPLAY_MODE_LABELS.DIPLOME,
    value: CAMPAGNES_DISPLAY_MODE[CAMPAGNES_DISPLAY_MODE_LABELS.DIPLOME],
  },
  {
    label: CAMPAGNES_DISPLAY_MODE_LABELS.ETABLISSEMENT,
    value: CAMPAGNES_DISPLAY_MODE[CAMPAGNES_DISPLAY_MODE_LABELS.ETABLISSEMENT],
  },
  {
    label: CAMPAGNES_DISPLAY_MODE_LABELS.ALL,
    value: CAMPAGNES_DISPLAY_MODE[CAMPAGNES_DISPLAY_MODE_LABELS.ALL],
  },
];
