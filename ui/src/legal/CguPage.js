...
const CguPage = () => {
  return (
    <Container>
      ...
      <p>
        Sirius est un questionnaire qui permet de recueillir les témoignages et retours d’expérience des apprentis pour
        les exposer aux collégiens dans le but de les aider dans leurs choix d’orientation et pour améliorer
      ...
      <p>
        « L'Apprenti » est tout apprenti contacté pour répondre au questionnaire et qui souhaite donner son avis sur sa
        formation. Il n’a pas de compte.
      </p>
      ...
      <p>
        ...
        sont possibles et répondre à des messages de collégiens pour leur donner un retour d’expérience. Nous rappelons
        que ces informations ne sont pas rattachées à une personne physique, mais à une URL fournie à la classe entière
        et anonymes.
      </p>
      <h3>Article 5 - Responsabilités</h3>
      <h4>5.1 L’éditeur de « Sirius »</h4>
      <p>
        Les sources des informations diffusées sur le site sont réputées fiables mais le site ne garantit pas qu’il soit
        exempt de défauts, d’erreurs ou d’omissions.
      </p>
      <p>
        L’éditeur s’engage à la sécurisation du site, notamment en prenant toutes les mesures nécessaires permettant de
        garantir la sécurité et la confidentialité des informations fournies. Il le réalise dans la limite des capacités
        techniques liées au chiffrement.
      </p>
      <p>
        L’éditeur fournit les moyens nécessaires et raisonnables pour assurer un accès continu au site. Il se réserve la
        liberté de faire évoluer, de modifier ou de suspendre, sans préavis, le site pour des raisons de maintenance ou
