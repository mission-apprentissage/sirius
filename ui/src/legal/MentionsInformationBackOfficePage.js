    ...
    <>
      ...
      <Container>
        ...
        <p>
          ...
          témoignages et retours d’expérience d’apprentis et de les exposer aux collégiens pour les aider dans leurs
          choix d’orientation.
        </p>
        <p>
        ...
        <p>
          Pour vous permettre de créer un compte de gestion lié à votre CFA, nous traitons les données suivantes
          relatives aux agents : nom, prénom, adresse e-mail.
        </p>
        <p>
          <b>
        ...
        <p>
          ...
          <i>
            “de contribuer aux études et recherches relatives aux méthodes et aux moyens propres à faciliter
            l'information et l'accompagnement à l'orientation tout au long de la vie ; de contribuer aux études et
            recherches tendant à améliorer la connaissance des activités professionnelles et de leur évolution” et plus
            généralement d'apporter “sa collaboration aux administrations et aux organismes intéressés par les questions
            qui relèvent de sa compétence, [...] en vue de l'élaboration et de la mise en oeuvre de la politique
        ...
        <p>
          ...
          personnel qui incombe au responsable de traitement, les demandes des personnes concernées ne seront traitées
          que si nous sommes en mesure de vous identifier de façon certaine.
        </p>
        <p>
