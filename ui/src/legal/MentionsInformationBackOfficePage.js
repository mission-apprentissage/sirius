...
const MentionsInformationBackOfficePage = () => {
  return (
    <Container>
      ...
      <p>
        Sirius est développé au sein de la Mission InserJeunes et permet via un questionnaire de recueillir les
        témoignages et retours d’expérience d’apprentis et de les exposer aux collégiens pour les aider dans leurs choix
        d’orientation.
      </p>
      <p>
        Le responsable de traitement est la Délégation générale à l’emploi et à la formation professionnelle,
        représentée par Monsieur Bruno Lucas. Le service numérique est en cours de transfert vers l’ONISEP.
      </p>
      <h3>Finalités</h3>
      <p>
        Sirius peut collecter des données à caractère personnel pour permettre aux agents de créer des questionnaires
        permettant de recueillir les témoignages et retours d’expérience d’apprentis et de jeunes.
      </p>
      <h3>Données personnelles traitées</h3>
      <p>
        Pour vous permettre de créer un compte de gestion lié à votre CFA, nous traitons les données suivantes relatives
        aux agents : nom, prénom, adresse e-mail.
      </p>
      <p>
        <b>
          Nous rappelons que les données contenues dans les formulaires ne sont pas rattachées à des individus mais à
          des formations CFA.
        </b>
      </p>
      <h3>Base juridique du traitements de données</h3>
      <p>
        Les données traitées par le site sont fondées sur l’exécution d’une mission d’intérêt public ou relevant de
        l’exercice de l’autorité publique dont est investi le responsable de traitement au sens de l’article 6-e du
        RPGD.
      </p>
      <p>
        Cette mission d’intérêt public est notamment précisée à l’article D.313-14 du code de l’éducation qui prévoit
        notamment que l’ONISEP est chargée{" "}
        <i>
          “de contribuer aux études et recherches relatives aux méthodes et aux moyens propres à faciliter l'information
          et l'accompagnement à l'orientation tout au long de la vie ; de contribuer aux études et recherches tendant à
          améliorer la connaissance des activités professionnelles et de leur évolution” et plus généralement d'apporter
          “sa collaboration aux administrations et aux organismes intéressés par les questions qui relèvent de sa
          compétence, [...] en vue de l'élaboration et de la mise en oeuvre de la politique coordonnée de formation
      ...
      <p>
        Les données à caractère personnel sont conservées pour une durée de 2 mois à compter du départ (connu par
        l’ONISEP) de l’agent ou au plus tard après 2 ans d’inactivité de compte d’un agent.
      </p>
      ...
      <p>
        ...
        éléments sont indispensables pour nous permettre de retrouver votre recherche – :
      </p>
      <ul>
        <li>
          Par courriel :{" "}
        ...
        <li>
          Ou par courrier postal : ONISEP , A l’attention du Délégué à la Protection des Données, 12 mail Barthélémy
          Thimonnier, CS10450 Lognes, 77437 Marne-la-Vallée cedex 2
        </li>
      </ul>
      <p>
        En raison de l'obligation de sécurité et de confidentialité dans le traitement des données à caractère personnel
        qui incombe au responsable de traitement, les demandes des personnes concernées ne seront traitées que si nous
        sommes en mesure de vous identifier de façon certaine.
      </p>
      <p>
        En cas de doute sérieux sur votre identité, nous pouvons être amenés à vous demander la communication d’une
        preuve d’identité.
      </p>
      <p>
      ...
      <p>Seules les personnes strictement habilitées ont accès aux données à l’ONISEP et à la DGEFP.</p>
