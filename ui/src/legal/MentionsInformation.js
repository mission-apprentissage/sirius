  ...
  return (
    ...
    >
      <Stack spacing="4">
        ...
        <Text>
          Sirius ne collecte aucune donnée à caractère personnel. Seules les réponses sélectionnées
          dans le questionnaire sont enregistrées.
        </Text>
        <Text fontSize="lg" fontWeight="semibold">
          Où sont stockées vos données ?
        </Text>
        <Text>
          Sirius stocke vos données de contact sur AlwaysData et vos réponses au questionnaire chez
          OVH, en France.
        </Text>
        <Text fontSize="lg" fontWeight="semibold">
        ...
        <Text>Aucun transfert de données en dehors de l’Union européenne n’est mis en œuvre.</Text>
        <Text fontSize="lg" fontWeight="semibold">
        ...
        <Divider />
        <Text>
          Le traitement de vos données issues de ce questionnaire est effectué par l’Onisep, 12 mail
          Barthélémy Thimonnier, 77437 Marne la Vallée cedex 2 CS 10450, représenté par sa
          Directrice générale, Frédérique Alexandre-Bailly, pour le compte de la DGEFP. Vos données
          de contact sont utilisées uniquement pour cette enquête. Elles sont supprimées à l’issue
          de l’enquête.
        </Text>
        <Text>
          Conformément aux articles 12 à 23 du règlement général (UE) sur la protection des données
          n°2016/679 du 27 avril 2016 et à la loi Informatique et libertés n°78-17 du 6 janvier 1978
          modifiée, vous disposez d’un droit d’accès, de rectification, d’effacement et
          d’opposition.
        </Text>
        <Text>
        ...
        <Box ml="4">
          <UnorderedList>
            ...
            <ListItem>
              ...
              Données, 12 mail Barthélémy Thimonnier, CS10450 Lognes, 77437 Marne-la-Vallée cedex 2
            </ListItem>
          </UnorderedList>
        </Box>
        <Text>
