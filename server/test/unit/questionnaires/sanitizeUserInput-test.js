...
const sanitize = require("../../../src/questionnaires/utils/sanitizeUserInput");
...
describe(__filename, function () {
  ...
  it("should remove HTML tags and unescape HTML entities", () => {
    assert.strictEqual(
      sanitize("je suis un <strong>h4ck3r très à l&apos;écoute</strong>"),
      "je suis un h4ck3r très à l'écoute"
    );
  });
