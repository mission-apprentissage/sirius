...
import { STRATEGIES } from "../src/middlewares/verifyUserMiddleware";

faker.locale = "fr";

export const newCampagne = (custom = {}, _hasId = false) => {
  return _.merge(
    {
...
export const newTemoignage = (custom = {}, _hasId = false) => {
  return _.merge(
    {
...
export const newFormation = (custom = {}, _hasId = false) => {
  return _.merge(
    {
      //...(hasId && { id: ObjectId(faker.database.mongodbObjectId()) }),
      data: {
...
export const newEtablissement = (custom = {}, _hasId = false) => {
  return _.merge(
    {
      //...(hasId && { id: ObjectId(faker.database.mongodbObjectId()) }),
      data: {
...
export const newQuestionnaire = (custom = {}, _hasId = false) => {
  return _.merge(
    {
      //...(hasId && { id: ObjectId(faker.database.mongodbObjectId()) }),
